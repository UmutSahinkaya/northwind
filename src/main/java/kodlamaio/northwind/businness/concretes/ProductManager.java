package kodlamaio.northwind.businness.concretes;
...
public class ProductManager implements ProductService {
    ...
    private ProductDao productDao;//injection yapılıyor.

    @Autowired//Spring gidip arka planda buna karşı gelebilecek bir sınıfı üretip onu veriyor.
